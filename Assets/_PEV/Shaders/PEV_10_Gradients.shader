...
Shader "Shader Forge/NoSe" {
    Properties {
        ...
        _Width ("Width", Range(0, 1)) = 0.1941748
        _Height ("Height", Range(0, 1)) = 0.4951456
    }
    SubShader {
        Tags {
...
////// Lighting:
                ...
                float Gradient = _NoiseTexture_var.r;
                ...
                float node_3305 = TriangleGradiet;
                float3 finalColor = float3(node_3305,node_3305,node_3305);
